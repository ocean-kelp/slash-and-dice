...
export const fireball: Skill = {
  ...
  skillType: [SkillType.MAGIC, SkillType.TARGETING],
  elementType: ElementType.FLAME,
  description: {
    en:
      "Summons a fireball that seeks an enemy and explodes. 15% chance to inflict Burn.",
    es: "",
    kr: "",
    jp: "",
    "zh-Hans": "",
  ...
  modifications: {
    I: {
      ...
      description: {
        en: "+1 additional explosion (50% damage/size)",
        es: "",
        kr: "",
        jp: "",
        "zh-Hans": "",
    ...
    special: {
      ...
      description: {
        en: "+50% damage; +50% size; +50% burn chance",
        es: "",
        kr: "",
        jp: "",
        "zh-Hans": "",
